...
// node_modules/spatial-controls/dist/index.js
var Action = ((Action2) => {
...
var PointerBehaviour = ((PointerBehaviour2) => {
...
var ZoomStrategy = class {
  ...
  constructor(rotationManager, zoomIn) {
     ...
     * A rotation manager.
     */
    __publicField(this, "rotationManager");
    /**
...
var m = new Matrix4();
var _a;
var RotationManager = (_a = class extends EventDispatcher {
  /**
  ...
  constructor(position, quaternion, target, settings) {
     ...
     */
    __publicField(this, "spherical0");
    /**
     * The spherical target coordinates.
     */
    __publicField(this, "spherical1");
    /**
     * Scalar dampers.
     */
    __publicField(this, "scalarDampers");
    /**
     * A timestamp.
     */
    ...
    this.timestamp = 0;
    this.updateEvent = { type: _a.EVENT_UPDATE };
    this.scalarDampers = [
      new ScalarDamper(),
      new ScalarDamper(),
      new ScalarDamper()
  ...
  zoom(sign) {
    ...
    if (zoom.enabled && settings.general.mode === "third-person") {
 ...
 * @event
 */
__publicField(_a, "EVENT_UPDATE", "update"), _a);
var PointerButton = ((PointerButton2) => {
...
var Bindings = class _Bindings {
  ...
  constructor() {
     ...
     */
    __publicField(this, "defaultActions");
    /**
...
var _a2;
var GeneralSettings = (_a2 = class extends EventDispatcher {
  /**
  ...
  constructor() {
     ...
     */
    __publicField(this, "_previousMode");
  ...
  set mode(value) {
    if (this._mode !== value) {
      this._mode = value;
      this.dispatchEvent({ type: _a2.EVENT_CHANGE });
 ...
 * @event
 */
__publicField(_a2, "EVENT_CHANGE", "change"), _a2);
var _a3;
var PointerSettings = (_a3 = class extends EventDispatcher {
  /**
  ...
  constructor() {
     ...
     * @see {@link behaviour}
     */
    __publicField(this, "_behaviour");
    /**
     * @see {@link sensitivity}
     */
    __publicField(this, "_sensitivity");
    this._behaviour = "default";
  ...
  set behaviour(value) {
    ...
    this.dispatchEvent({ type: _a3.EVENT_CHANGE });
  }
  /**
 ...
 * @event
 */
__publicField(_a3, "EVENT_CHANGE", "change"), _a3);
var x = new Vector3(1, 0, 0);
var y = new Vector3(0, 1, 0);
var z = new Vector3(0, 0, 1);
var _a4;
var RotationSettings = (_a4 = class extends EventDispatcher {
  /**
  ...
  constructor() {
     ...
     */
    __publicField(this, "_pivotOffset");
    /**
     * @see {@link minAzimuthalAngle}
     */
    __publicField(this, "_minAzimuthalAngle");
    /**
     * @see {@link maxAzimuthalAngle}
     */
    __publicField(this, "_maxAzimuthalAngle");
    /**
     * @see {@link minPolarAngle}
     */
    __publicField(this, "_minPolarAngle");
    /**
     * @see {@link maxPolarAngle}
     */
    __publicField(this, "_maxPolarAngle");
    /**
     * @see {@link invertedX}
     */
    __publicField(this, "_invertedX");
    /**
     * @see {@link invertedY}
     */
    __publicField(this, "_invertedY");
    /**
     * @see {@link sensitivityX}
     */
    __publicField(this, "_sensitivityX");
    /**
     * @see {@link sensitivityY}
     */
    __publicField(this, "_sensitivityY");
    /**
     * @see {@link damping}
     */
    __publicField(this, "_damping");
    this._enabled = true;
  ...
  set enabled(value) {
    this._enabled = value;
    this.dispatchEvent({ type: _a4.EVENT_CHANGE });
  }
  /**
 ...
 * @event
 */
__publicField(_a4, "EVENT_CHANGE", "change"), _a4);
var _a5;
var TranslationSettings = (_a5 = class extends EventDispatcher {
  /**
  ...
  constructor() {
     ...
     */
    __publicField(this, "_boostMultiplier");
    /**
     * @see {@link axisModifier}
     */
    __publicField(this, "_axisWeights");
    /**
     * @see {@link damping}
     */
    __publicField(this, "_damping");
  ...
  set enabled(value) {
    this._enabled = value;
    this.dispatchEvent({ type: _a5.EVENT_CHANGE });
  }
  /**
 ...
 * @event
 */
__publicField(_a5, "EVENT_CHANGE", "change"), _a5);
var _a6;
var ZoomSettings = (_a6 = class extends EventDispatcher {
  /**
  ...
  constructor() {
     ...
     * @see {@link inverted}
     */
    __publicField(this, "_inverted");
    /**
     * @see {@link minDistance}
     */
    __publicField(this, "_minDistance");
    /**
  ...
  set enabled(value) {
    this._enabled = value;
    this.dispatchEvent({ type: _a6.EVENT_CHANGE });
  }
  /**
 ...
 * @event
 */
__publicField(_a6, "EVENT_CHANGE", "change"), _a6);
var _a7;
var Settings = (_a7 = class extends EventDispatcher {
  /**
  ...
  constructor() {
     ...
     */
    __publicField(this, "keyBindings");
    /**
     * Pointer bindings.
     *
     * This collection maps {@linkplain PointerButton pointer buttons} to {@linkplain Action actions}.
     */
    __publicField(this, "pointerBindings");
    /**
     * General settings.
     */
    __publicField(this, "general");
    /**
     * Pointer settings.
     */
    ...
    this.general.addEventListener(_a7.EVENT_CHANGE, (e) => this.dispatchEvent(e));
    this.pointer.addEventListener(_a7.EVENT_CHANGE, (e) => this.dispatchEvent(e));
    this.rotation.addEventListener(_a7.EVENT_CHANGE, (e) => this.dispatchEvent(e));
    this.translation.addEventListener(_a7.EVENT_CHANGE, (e) => this.dispatchEvent(e));
    this.zoom.addEventListener(_a7.EVENT_CHANGE, (e) => this.dispatchEvent(e));
  }
  /**
  ...
  copy(settings) {
    ...
    this.dispatchEvent({ type: _a7.EVENT_CHANGE });
    return this;
  }
  /**
 ...
 * @event
 */
__publicField(_a7, "EVENT_CHANGE", "change"), _a7);
var v2 = new Vector3();
var p = new Vector2();
var _a8;
var RotationControls = (_a8 = class extends EventDispatcher {
  /**
   ...
   * @param settings - The settings.
   */
  constructor(position = new Vector3(), quaternion = new Quaternion(), target = new Vector3(), settings = new Settings()) {
    super();
    /**
     * @see {@link domElement}
     */
    ...
    this.rotationManager.addEventListener(_a8.EVENT_UPDATE, (e) => this.dispatchEvent(e));
    this.strategies = /* @__PURE__ */ new Map([
      [6, new ZoomStrategy(this.rotationManager, false)],
      [7, new ZoomStrategy(this.rotationManager, true)],
      [9, new RotationStrategy(this)]
    ]);
  }
  /**
  ...
  setPointerLocked(locked = true) {
    var _a12;
    if (locked) {
      if (document.pointerLockElement !== this.domElement && ((_a12 = this.domElement) == null ? void 0 : _a12.requestPointerLock) !== void 0) {
  ...
  setRotationEnabled(enabled) {
    ...
    if (this.settings.rotation.enabled && enabled) {
      (_a12 = this.domElement) == null ? void 0 : _a12.addEventListener("pointermove", this, { passive: true });
    } else {
      (_b = this.domElement) == null ? void 0 : _b.removeEventListener("pointermove", this);
    }
  }
  /**
  ...
  handlePointerMoveEvent(event) {
    ...
    if (pointerBehaviour !== "lock-hold" || this.dragging) {
  ...
  handlePointerButtonEvent(event, pressed) {
    ...
    if (bindings.has(event.button)) {
      ...
      if (!(event instanceof PointerEvent && event.pointerType === "mouse")) {
        ...
        strategy == null ? void 0 : strategy.execute(pressed, event);
        if (action === 9) {
          this.dragging = pressed;
        }
      }
      if (event instanceof PointerEvent) {
        if (pressed && behaviour === "default") {
          (_a12 = this.domElement) == null ? void 0 : _a12.setPointerCapture(event.pointerId);
        }
      }
    }
  }
  ...
  handlePointerCancelEvent(event) {
    var _a12;
    (_a12 = this.domElement) == null ? void 0 : _a12.removeEventListener("pointermove", this);
  }
  /**
  ...
  handleKeyboardEvent(event, pressed) {
    ...
    if (keyBindings.has(code)) {
      ...
      strategy == null ? void 0 : strategy.execute(pressed);
    }
  }
  /**
 ...
 * @event
 */
__publicField(_a8, "EVENT_UPDATE", "update"), _a8);
var BoostStrategy = class {
  ...
  constructor(movementState) {
     ...
     * A movement state.
     */
    __publicField(this, "movementState");
...
var v3 = new Vector3();
var _a9;
var TranslationManager = (_a9 = class extends EventDispatcher {
  /**
  ...
  constructor(position, quaternion, target, settings) {
     ...
     * The current velocity.
     */
    __publicField(this, "velocity0");
    /**
     * The target velocity.
     */
    __publicField(this, "velocity1");
    /**
     * Scalar dampers.
     */
    __publicField(this, "scalarDampers");
    ...
    this.timestamp = 0;
    this.updateEvent = { type: _a9.EVENT_UPDATE };
    this.scalarDampers = [
      new ScalarDamper(),
      new ScalarDamper(),
      new ScalarDamper()
 ...
 * @event
 */
__publicField(_a9, "EVENT_UPDATE", "update"), _a9);
var _a10;
var TranslationControls = (_a10 = class extends EventDispatcher {
  /**
   * Constructs new controls.
   *
   * @param position - A position.
  ...
  constructor(position = new Vector3(), quaternion = new Quaternion(), target = new Vector3(), settings = new Settings()) {
     ...
     */
    __publicField(this, "translationManager");
    /**
     * A map that links actions to specific strategies.
     */
    __publicField(this, "strategies");
    ...
    this.translationManager.addEventListener(_a10.EVENT_UPDATE, (e) => this.dispatchEvent(e));
    const state = this.translationManager.movementState;
    this.strategies = /* @__PURE__ */ new Map([
      [0, new MovementStrategy(
        state,
        0
        /* FORWARD */
      )],
      [1, new MovementStrategy(
        state,
        1
        /* LEFT */
      )],
      [2, new MovementStrategy(
        state,
        2
        /* BACKWARD */
      )],
      [3, new MovementStrategy(
        state,
        3
        /* RIGHT */
      )],
      [4, new MovementStrategy(
        state,
        4
        /* DOWN */
      )],
      [5, new MovementStrategy(
        state,
        5
        /* UP */
      )],
      [8, new BoostStrategy(state)]
    ]);
  }
  /**
   * The position.
 ...
 * @event
 */
__publicField(_a10, "EVENT_UPDATE", "update"), _a10);
var v4 = new Vector3();
...
var _a11;
var SpatialControls = (_a11 = class extends EventDispatcher {
  /**
   * Constructs new controls.
   *
   * @param position - A position.
   ...
   */
  constructor(position = new Vector3(), quaternion = new Quaternion(), domElement = null) {
    super();
    /**
     * @see {@link domElement}
     */
     ...
     */
    __publicField(this, "previousQuaternion");
    /**
     * The previous target.
     */
    __publicField(this, "previousTarget");
    /**
     * Rotation controls.
     */
    __publicField(this, "rotationControls");
    /**
     * Translation controls.
     */
    __publicField(this, "translationControls");
    /**
     * @see {@link enabled}
     */
    __publicField(this, "_enabled");
    ...
    this.rotationControls.addEventListener(_a11.EVENT_UPDATE, (e) => this.dispatchEvent(e));
    this.translationControls.addEventListener(_a11.EVENT_UPDATE, (e) => this.dispatchEvent(e));
 ...
 * @event
 */
__publicField(_a11, "EVENT_UPDATE", "update"), _a11);
export {
  Action,
  Bindings,
  BoostStrategy,
...
spatial-controls/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=spatial-controls.js.map
